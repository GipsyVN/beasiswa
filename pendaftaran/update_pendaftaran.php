                    ...
                    <div class="card-body">
                       <div class="form-group">
                        ...
                        <select class="form-control chosen" name="jb">
                            ...
                            <option value="Kurang Mampu" <?php echo ($row['jenis_beasiswa'] == 'Kurang Mampu') ? 'selected' : ''; ?>>Kurang Mampu</option>
                            <option value="Tugas Akhir" <?php echo ($row['jenis_beasiswa'] == 'Tugas Akhir') ? 'selected' : ''; ?>>Tugas Akhir</option>
                        </select>
                    </div>
